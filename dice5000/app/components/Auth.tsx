  ...
  return (
    ...
    <div className=" items-center justify-center border bg-gray-100 p-5 w-96 rounded-lg shadow-lg">
        ...
        <div className="flex-1 flex items-center  mb-4 p-6 flex-col">
            ...
            <div className="bg-red-300 flex items-center justify-center w-full h-full mb-4 border hover:bg-gray-300 rounded p-2 text-xl ">
            <button onClick={signInWithGoogle}>Sign in with Google</button>
            </div>
            <div className="bg-gray-300 flex items-center justify-center w-full h-full mb-4 border text-xl hover:bg-gray-300 rounded p-2 ">
            <button onClick={signInWithGithub}>Sign in with GitHub</button>
            </div>

        <div className="bg-gray-200 flex flex-col items-center justify-center w-full h-full mb-4 border rounded p-5 mb-2 gap-2">
